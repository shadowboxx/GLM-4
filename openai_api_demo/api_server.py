...
# set LLM path
MODEL_PATH = os.environ.get('MODEL_PATH', 'd:\LLM\models\THUDM\chatglm3-6b')
...
if __name__ == "__main__":
    ...
    # model, tokenizer = inference_hf.load_model_and_tokenizer(MODEL_PATH)
